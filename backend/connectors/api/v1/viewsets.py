...
class NewConnectorbackendhesViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_NEW_CONNECTOR_BACKEND_HES_PASSWORD
    USERNAME = settings.CONNECTOR_NEW_CONNECTOR_BACKEND_HES_USERNAME
    BASE_URL = (
        "https://crowdbotics-slack-dev.herokuapp.com/dashboard/app/120072/connectors"
    )
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_NEW_CONNECTOR_BACKEND_HES"
